...
int main() {
    if (!load_config("agent/config/agent_config.json")) {
        fprintf(stderr, "Failed to load agent/config/agent_config.json\n");
        return 1;
    }
    ...
    if (!anti_tamper.VerifyConfigSignature("agent/config/agent_config.json", g_config_signature_path)) {
