...
- Open `agent/drivers/dlp_minifilter.vcxproj` in Visual Studio.
...
**Project structure**
```
agent/src/enterprise/telemetry/
  secure_telemetry.h
...
**Project structure**
```
agent/src/enterprise/anti_tamper/
  anti_tamper.h
  anti_tamper.cpp
```
...
**Project structure**
```
agent/src/enterprise/extraction/
  content_extractor.h
...
```
agent/src/enterprise/rules/rule_schema_v2.json
agent/src/enterprise/service/service_installer_manifest.xml
```
